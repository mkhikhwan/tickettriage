...
class Settings:
    # ---- Storage -------------------------------------------------------
    cosmos_connection_string: str = field(default_factory=lambda: _clean(os.environ.get("CosmosDBConnectionString")))
    ...
    cosmos_database: str = field(default_factory=lambda: _clean(os.environ.get("COSMOS_DATABASE")) or "HelpdeskDB")
    ...
    def cosmos_configured(self) -> bool:
        return bool(self.cosmos_connection_string or (self.cosmos_endpoint and self.cosmos_key))
